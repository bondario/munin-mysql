     ...
     wsrep_transactions => {
        ...
        data_sources => [
            {name => 'wsrep_last_committed', label => 'Committed transactions',
                                             info  => 'num of committed transactions.',
                                             type  => 'COUNTER',
                                             min   => 0,
                                             max   => 'U'},
            {name => 'wsrep_local_commits',  label => 'Locally Committed transactions',
                                             info  => 'num of locally committed transactions.',
                                             type  => 'COUNTER',
                                             min   => 0,
                                             max   => 'U'},
        ],
     ...
     wsrep_writesets => {
        ...
        data_sources => [
            {name => 'wsrep_replicated', label => 'Writesets sent',
                                         info  => 'num of writesets sent to other nodes',
                                         type  => 'COUNTER',
                                         min   => 0,
                                         max   => 'U'},
            {name => 'wsrep_received',   label => 'Writesets received',
                                         info  => 'num of writesets received from other nodes',
     ...
     wsrep_writesetbytes => {
        ...
        data_sources => [
            {name => 'wsrep_replicated_bytes', label => 'Writesets bytes sent',
                                               info  => 'num of bytes in writesets sent to other nodes',
                                               type  => 'DERIVE',
                                               min   => 0,
                                               max   => 'U'},
            {name => 'wsrep_received_bytes',   label => 'Writesets bytes received',
                                               info  => 'num of bytes in writesets received from other nodes',
     ...
     wsrep_avgwritesetbytes => {
        ...
        data_sources => [
            ...
            {name => 'wsrep_replicated_bytes', type  => 'DERIVE',
                                               graph => 'no',
                                               label => 'replicated_bytes',
                                               min   => 0,
                                               max   => 'U'},
            {name => 'wsrep_received_bytes',   type  => 'DERIVE',
                                               graph => 'no',
                                               label => 'received_bytes',
                                               min   => 0,
                                               max   => 'U'},
